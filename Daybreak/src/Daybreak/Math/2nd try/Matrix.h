...
namespace Daybreak
{
	struct Mat4
	{
		...
		static inline Mat4 Zero() { return Mat4(1.0f); }
		...
		static inline Mat4 Translation(Vec3 position); // this will just make a default translation matrix for that position
		static inline Mat4 Translation(Mat4 mat, Vec3 position); // this will modify the input matrix to be a translation matrix
