...
namespace Daybreak
{
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture,
							 const glm::vec4& tintColor = glm::vec4(1.0f), const float& tilingFactor = 1.0f, int entityID = -1);
		...
		static void DrawCircle(const glm::mat4& transform, const glm::vec4& color = glm::vec4(1.0f), const float fade = 0.0f,
		...
		static void DrawString(const std::string& string, const Ref<Font>& font, const glm::mat4& transform,
							   ...
							   int entityID = -1);
		static void DrawString(const std::string& string, const Ref<Font>& font, const glm::vec3& position, const glm::vec2& size,
							   const glm::vec4& color = glm::vec4(1.0f), float kerning = 0.0f, float lineSpacing = 0.0f,
							   int entityID = -1);
	};
