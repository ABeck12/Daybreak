...
namespace Daybreak
{
	...
	public:
		...
		static inline void SetDepthTesting(bool enabled) { s_RenderAPI->SetDepthTesting(enabled); }
		static inline void SetBlendMode(RenderAPI::BlendModes mode) { s_RenderAPI->SetBlendMode(mode); }
